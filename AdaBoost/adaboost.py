...
full_preproc = ColumnTransformer([('num', num_preproc, numeric_cols + binary_cols),
...
param_grid_ada = {
    ...
    'regressor__estimator__max_depth': [3, 5, 7, 10]
}
...
mse_ada, rmse_ada, r2_ada = evaluate_and_save(
    "AdaBoost GridSearch",
    best_ada,
    X_val,
    y_val,
    test.drop('Hospital_Id', axis=1),
    "AdaBoost_GridSearch_submission.csv"
)

print("\n===== FINAL GRIDSEARCH ADABOOST MODEL PERFORMANCE =====")
print(f"MSE: {mse_ada:.2f}, RMSE: {rmse_ada:.2f}, R²: {r2_ada:.4f}")
