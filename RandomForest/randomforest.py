...
mse_rf, rmse_rf, r2_rf = evaluate_and_save(
    "Random Forest GridSearch", best_rf, X_val, y_val, test.drop('Hospital_Id', axis=1), "RandomForest_GridSearch_submission.csv"
)

print("\n===== FINAL GRIDSEARCH RANDOM FOREST MODEL PERFORMANCE =====")
print(f"MSE: {mse_rf:.2f}, RMSE: {rmse_rf:.2f}, R²: {r2_rf:.4f}")
