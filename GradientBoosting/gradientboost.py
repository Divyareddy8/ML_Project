...
mse_gbr, rmse_gbr, r2_gbr = evaluate_and_save(
    "Gradient Boosting GridSearch",
    best_gbr,
    X_val,
    y_val,
    test.drop('Hospital_Id', axis=1),
    "GradientBoosting_GridSearch_submission.csv"
)

print("\n===== FINAL GRIDSEARCH GRADIENT BOOSTING MODEL PERFORMANCE =====")
print(f"MSE: {mse_gbr:.2f}, RMSE: {rmse_gbr:.2f}, R²: {r2_gbr:.4f}")
